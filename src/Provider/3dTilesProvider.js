...
import { Tileset } from 'Provider/3dTilesClasses';
...
function preprocessDataLayer(layer, view, scheduler) {
    ...
    layer.cleanupDelay = layer.cleanupDelay || 10000000;
    ...
    return Fetcher.json(layer.url, layer.networkOptions).then((tileset) => {
        ...
        layer.tileIndex = new Tileset(tileset, urlPrefix, layer.registeredExtensions);
